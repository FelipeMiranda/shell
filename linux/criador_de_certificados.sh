...
if [ $? == 0 ]; then
      ...
      echo -en "\n\n\n-> Certificados criados na pasta $magenta ['$(pwd)/certificados/keys'] $magenta \n"
      echo -en "\n$green$> ls $red ./certificados/keys\n$cyan"
      ls -la ./certificados/keys
      echo -en "$normal"
      echo -en "\n\n\n\t$green $alert Certificados criados com $normal $green sucesso !\n\n\n"
else
